...
import VerifyOTPPage from './pages/VerifyOTPPage'        // ✅ public page
    ...
    <>
      ...
      <Router>
        <Routes>
          ...
          <Route path="/verify-otp"  element={<VerifyOTPPage />} />  {/* ✅ Must be public — user is not logged in yet */}
...
function RoleBasedDashboard() {
  ...
  if (user.is_superuser) return <SystemAdminDashboard />
